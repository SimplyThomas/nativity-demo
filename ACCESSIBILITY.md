...
**Scope:** all 12 pages × 2 viewports (1440×900 desktop, 390×844 mobile) = 24 runs
...
npm run audit:a11y   # 12 pages x 2 viewports
...
- **Content outside landmarks** (`region`, all 12 pages): the top bar sat
