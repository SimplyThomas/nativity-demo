...
| `dist/chunks/` | **Generated.** 106 chunks + an asset-rewritten stylesheet. What a volunteer pastes into EVO. |
...
The nineteen `.html` files at the repo root are the **source** — edit them
