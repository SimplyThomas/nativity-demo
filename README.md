...
| `dist/chunks/` | **Generated.** 144 chunks + an asset-rewritten stylesheet. What a volunteer pastes into EVO. |
...
The 32 `.html` files at the repo root are the **source** — edit them
