...
| `dist/chunks/` | **Generated.** 83 chunks + an asset-rewritten stylesheet. What a volunteer pastes into EVO. |
...
The eighteen `.html` files at the repo root are the **source** — edit them
