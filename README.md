...
| `dist/chunks/` | **Generated.** 72 chunks + an asset-rewritten stylesheet. What a volunteer pastes into EVO. |
...
The sixteen `.html` files at the repo root are the **source** — edit them
